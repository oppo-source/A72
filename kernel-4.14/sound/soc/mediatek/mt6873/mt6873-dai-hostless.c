...
static const struct snd_pcm_hardware mt6873_hostless_hardware = {
...
static const struct snd_soc_dapm_route mtk_dai_hostless_routes[] = {
	...
	{"ADDA Playback", NULL, "Hostless_ADDA_DL_I2S_OUT DL"},
        #ifdef VENDOR_EDIT
        /*huan@psw.audiodriver.ftm,2020/1/20,add for 19133 ring*/
				    ...
				    struct snd_soc_dai *dai)
{
	...
	snd_soc_set_runtime_hwparams(substream, &mt6873_hostless_hardware);
...
static struct snd_soc_dai_driver mtk_dai_hostless_driver[] = {
	...
	},
	{
		...
		.id = MT6873_DAI_HOSTLESS_SPH_ECHO_REF,
		.playback = {
	...
	},
	{
		...
		.id = MT6873_DAI_HOSTLESS_SPK_INIT,
		.playback = {
	...
	},
	{
		...
		.id = MT6873_DAI_HOSTLESS_IMPEDANCE,
		.playback = {
	...
	},
	{
		...
		.id = MT6873_DAI_HOSTLESS_SRC_BARGEIN,
		.playback = {
