...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0xB2,0x00, 0x02, 0x18, 0x90, 0x60, 0x00, 0x12, 0x34, 0x10, 0x08, 0x00, 0x49, 0x11, 0x01, 0x00, 0x00, 0x00, 0x00, 0x80, 0x13, 0xA3, 0x87);
	...
	jdi_dcs_write_seq_static(ctx, 0xBA,0x93);
	jdi_dcs_write_seq_static(ctx, 0xE9,0x3F);
	...
	jdi_dcs_write_seq_static(ctx, 0xE9,0x3F);
	jdi_dcs_write_seq_static(ctx, 0xBD,0x00);
	jdi_dcs_write_seq_static(ctx, 0xBC,0x04);
	jdi_dcs_write_seq_static(ctx, 0xBD,0x01);
