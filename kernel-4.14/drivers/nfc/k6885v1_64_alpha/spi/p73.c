...
static void p61_start_throughput_measurement(unsigned int type)
{
    ...
    {
        P61_ERR_MSG(KERN_ALERT " p61_start_throughput_measurement: wrong type = %d", type);
    }
        ...
        unsigned long arg)
{
    ...
    case P61_SET_DBG:
        ...
        P61_ERR_MSG(KERN_INFO"[NXP-P61] -  Debug level %d", debug_level);
        break;
    ...
    case P61_SET_POLL:
        ...
        {
            P61_ERR_MSG(KERN_INFO"[NXP-P61] - IRQ Mode is set \n");
        }
        else
        {
            P61_ERR_MSG(KERN_INFO"[NXP-P61] - Poll Mode is set \n");
            p61_dev->enable_poll_mode = 1;
        }
        break;
    case P61_SET_SPM_PWR:
        P61_ERR_MSG(KERN_ALERT " P61_SET_SPM_PWR: enter");
        ret = pn544_dev_ioctl(filp, P61_SET_SPI_PWR, arg);
        P61_ERR_MSG(KERN_ALERT " P61_SET_SPM_PWR: exit");
    break;
    case P61_GET_SPM_STATUS:
        P61_ERR_MSG(KERN_ALERT " P61_GET_SPM_STATUS: enter");
        ret = pn544_dev_ioctl(filp, P61_GET_PWR_STATUS, arg);
        P61_ERR_MSG(KERN_ALERT " P61_GET_SPM_STATUS: exit");
    break;
    case P61_SET_DWNLD_STATUS:
        P61_ERR_MSG(KERN_ALERT " P61_SET_DWNLD_STATUS: enter");
        ret = pn544_dev_ioctl(filp, PN544_SET_DWNLD_STATUS, arg);
        P61_ERR_MSG(KERN_ALERT " P61_SET_DWNLD_STATUS: =%lu exit",arg);
    break;
    case P61_SET_THROUGHPUT:
        p61_through_put_t.enable_through_put_measure = true;
        P61_ERR_MSG(KERN_INFO"[NXP-P61] -  P61_SET_THROUGHPUT enable %d", p61_through_put_t.enable_through_put_measure);
        break;
    case P61_GET_ESE_ACCESS:
        P61_ERR_MSG(KERN_ALERT " P61_GET_ESE_ACCESS: enter");
        ret = pn544_dev_ioctl(filp, P544_GET_ESE_ACCESS, arg);
        P61_ERR_MSG(KERN_ALERT " P61_GET_ESE_ACCESS ret: %d exit",ret);
    break;
    case P61_SET_POWER_SCHEME:
        P61_ERR_MSG(KERN_ALERT " P61_SET_POWER_SCHEME: enter");
        ret = pn544_dev_ioctl(filp, P544_SET_POWER_SCHEME, arg);
        P61_ERR_MSG(KERN_ALERT " P61_SET_POWER_SCHEME ret: %d exit",ret);
    break;
    case P61_INHIBIT_PWR_CNTRL:
        P61_ERR_MSG(KERN_ALERT " P61_INHIBIT_PWR_CNTRL: enter");
        ret = pn544_dev_ioctl(filp, P544_SECURE_TIMER_SESSION, arg);
        P61_ERR_MSG(KERN_ALERT " P61_INHIBIT_PWR_CNTRL ret: %d exit", ret);
    break;
    default:
        P61_ERR_MSG(KERN_ALERT " Error case");
        ret = -EINVAL;
    }

    P61_ERR_MSG(KERN_ALERT "p61_dev_ioctl-exit %u arg = %lu\n", cmd, arg);
    return ret;
}
        ...
        loff_t *offset)
{
    ...
    P61_ERR_MSG(KERN_ALERT "p61_dev_write -Enter count %zu\n", count);
        ...
        loff_t *offset)
{
    ...
    P61_ERR_MSG("p61_dev_read count %zu - Enter \n", count);
    ...
    if (p61_dev->enable_poll_mode)
    {
        ...
        P61_ERR_MSG(KERN_INFO"SPI_READ returned 0x%zx", count);
        //#ifndef VENDOR_EDIT
        //Weiwei.Deng@CN.NFC.Basic.Hardware,1779213, 2019/01/08,
        //Mod for buf for transceive SPI data
    ...
    P61_ERR_MSG(" %s P61_IRQ_ENABLE not Enabled \n", __FUNCTION__);
        ...
        if (0 > ret)
        {
            P61_ERR_MSG(KERN_INFO"SPI_READ returned 0x%x", ret);
            ret = -EIO;
            goto fail;
        }
    }
    ...
    P61_ERR_MSG(KERN_INFO"total_count = %zu", count);
