...
#define CLATM_INIT_CFG_0_THETA_RISE		(10)
#define CLATM_INIT_CFG_0_THETA_FALL		(15)
#define CLATM_INIT_CFG_0_MIN_BUDGET_CHG		(1)
#define CLATM_INIT_CFG_0_MIN_CPU_PWR		(570)
...
#define CLATM_INIT_CFG_1_FIRST_STEP		(2000)
#define CLATM_INIT_CFG_1_THETA_RISE		(10)
#define CLATM_INIT_CFG_1_THETA_FALL		(15)
#define CLATM_INIT_CFG_1_MIN_BUDGET_CHG		(1)
#define CLATM_INIT_CFG_1_MIN_CPU_PWR		(570)
#define CLATM_INIT_CFG_1_MAX_CPU_PWR		(3960)
#define CLATM_INIT_CFG_1_MIN_GPU_PWR		(200)
#define CLATM_INIT_CFG_1_MAX_GPU_PWR		(2000)

#define CLATM_INIT_CFG_2_TARGET_TJ		(69000)
#define CLATM_INIT_CFG_2_EXIT_POINT		(10000)
#define CLATM_INIT_CFG_2_FIRST_STEP		(2000)
#define CLATM_INIT_CFG_2_THETA_RISE		(10)
#define CLATM_INIT_CFG_2_THETA_FALL		(15)
#define CLATM_INIT_CFG_2_MIN_BUDGET_CHG		(1)
#define CLATM_INIT_CFG_2_MIN_CPU_PWR		(570)
