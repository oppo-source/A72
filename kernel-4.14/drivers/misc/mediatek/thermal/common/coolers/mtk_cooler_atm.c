...
static int MAX_TARGET_TJ = 85000;
static int STEADY_TARGET_TJ = 70000;
static int TRIP_TPCB = 60000;
static int STEADY_TARGET_TPCB = 62000;
static int MAX_EXIT_TJ = 80000;
static int STEADY_EXIT_TJ = 60000;
static int COEF_AE = 690000;
static int COEF_BE = 10000;
static int COEF_AX = 680000;
static int COEF_BX = 10000;
#if defined(CATM_TPCB_EXTEND)
...
static int K_SUM_TT_LOW = 500;
/* for ATM polling delay 50ms, increase this based on polling delay */
static int K_SUM_TT_HIGH = 500;
...
static int CATMP_STEADY_TTJ_DELTA = 13500;
/* --- cATM+ parameters --- */
#endif
#endif	/* end of CPT_ADAPTIVE_AP_COOLER */
...
#ifdef ATM_USES_PPM
//	MINIMUM_CPU_POWERS[0] =
//		mt_ppm_thermal_get_min_power() + 1;
//	MAXIMUM_CPU_POWERS[0] =
//		mt_ppm_thermal_get_max_power() + 1;
#endif
	/* choose OPP with power "<=" limit */
	//MINIMUM_GPU_POWERS[0] = (int) mt_gpufreq_get_min_power() + 1;
	/* choose OPP with power "<=" limit */
	MAXIMUM_GPU_POWERS[0] = (int) mt_gpufreq_get_max_power() + 1;
	catmplus_update_params();
