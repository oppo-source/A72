...
static int is_sensor_searched = 0;
#endif
...
static kal_uint32 close(void)
{
    ...
    /*No Need to implement this function*/
    is_sensor_searched = 0;  //once opened we should enabled for next search - in case that camerahalserver restart
