...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] =
{
	...
	0, 0, 3280, 2464, 8, 8, 3264, 2448}, /*Preview*/
	{6560, 4928,  0,   0, 6560, 4928, 3280, 2464,
	0, 0, 3280, 2464, 8, 8, 3264, 2448}, // capture
	{6560, 4928,  0,   0, 6560, 4928, 3280, 2464,
	0, 0, 3280, 2464, 8, 8, 3264, 2448}, /*video*/
	{6560, 4928,  0,   0, 6560, 4928, 3280, 2464,
	0, 0, 3280, 2464, 8, 8, 3264, 2448}, /*hs_video,don't use*/
	{6560, 4928, 16, 624, 6520, 3696, 3260, 1848,
	0, 4, 3280, 1840, 0, 0, 3264, 1840}, /* slim video*/
	{6560, 4928,  0,   0, 6560, 4928, 3280, 2464,
	0, 0, 3280, 2464, 8, 8, 3264, 2448}, /*custom1 not use*/
	{6560, 4928,  0,   0, 6560, 4928, 3280, 2464,
	0, 0, 3280, 2464, 8, 8, 3264, 2448}, /*custom2 not use*/
	{6560, 4928,  0,   0, 6560, 4928, 6560, 4928,
	0, 0, 6560, 4928, 0, 0, 6560, 4928}, // remosic
}; /*cpy from preview*/
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 516000;
		break;
