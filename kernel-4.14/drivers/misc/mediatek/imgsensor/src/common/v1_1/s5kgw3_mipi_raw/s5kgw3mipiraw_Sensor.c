...
#define PFX "s5kgw3_camera_sensor"
#define LOG_1 LOG_INF("s5kgw3,MIPI 4LANE\n")
/****************************   Modify end	**************************/
#define LOG_INF(format, args...) pr_debug(PFX "[%s] " format, __func__, ##args)

#ifdef VENDOR_EDIT
#define DEVICE_VERSION_S5KGW3	 "s5kgw3"
...
static kal_uint16 s5kgw3_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len);
...
static kal_uint8 gS5kgw3_SN[CAMERA_MODULE_SN_LENGTH];
static kal_uint8 gS5kgw3_CamInfo[CAMERA_MODULE_INFO_LENGTH];
static kal_uint8 gS5kgw3_EepData[DUALCAM_CALI_DATA_LENGTH_8ALIGN*2];
...
static void read_eepromData(void)
{
	...
	for (idx = 0; idx <DUALCAM_CALI_DATA_LENGTH; idx++) {
		gS5kgw3_EepData[idx] = read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_WIDE + idx);
		gS5kgw3_EepData[idx+DUALCAM_CALI_DATA_LENGTH_8ALIGN]
			= read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_TELE + idx);
	}
	for (idx = 0; idx <CAMERA_MODULE_SN_LENGTH; idx++) {
		gS5kgw3_SN[idx] = read_cmos_eeprom_8(0xB0 + idx);
		LOG_INF("gS5kgw3_SN[%d]: 0x%x  0x%x\n", idx, gS5kgw3_SN[idx]);
	}
	gS5kgw3_CamInfo[0] = read_cmos_eeprom_8(0x0);
	gS5kgw3_CamInfo[1] = read_cmos_eeprom_8(0x1);
	gS5kgw3_CamInfo[2] = read_cmos_eeprom_8(0x6);
	gS5kgw3_CamInfo[3] = read_cmos_eeprom_8(0x7);
	gS5kgw3_CamInfo[4] = read_cmos_eeprom_8(0x8);
	gS5kgw3_CamInfo[5] = read_cmos_eeprom_8(0x9);
	gS5kgw3_CamInfo[6] = read_cmos_eeprom_8(0xA);
	gS5kgw3_CamInfo[7] = read_cmos_eeprom_8(0xB);
	memcpy(&gOtpCheckdata[0][0], &gS5kgw3_EepData[0], 40);
	memcpy(&gOtpCheckdata[6][0],
		&gS5kgw3_EepData[DUALCAM_CALI_DATA_LENGTH_8ALIGN], 40);
}
...
static kal_int32 write_Module_data(ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	UINT32 i = 0;
	if(pStereodata != NULL) {
		pr_debug("s5kgw3 SET_SENSOR_OTP: 0x%x %d 0x%x %d\n",
		...
		if ((pStereodata->uSensorId == S5KGW3_SENSOR_ID) && (data_length == DUALCAM_CALI_DATA_LENGTH)
			&& ((data_base == S5KGW3_STEREO_START_ADDR_WIDE) || (data_base == S5KGW3_STEREO_START_ADDR_TELE))) {
			pr_debug("s5kgw3 Write: %x %x %x %x %x %x %x %x\n", pData[0], pData[39], pData[40], pData[1556],
			...
			write_eeprom_protect(1);
			msleep(6);
			if (data_base == S5KGW3_STEREO_START_ADDR_WIDE) {
				pr_debug("com 0x24D0:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_WIDE));
				pr_debug("com 0x24F7:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_WIDE+39));
				pr_debug("innal 0x24F8:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_WIDE+40));
				pr_debug("innal 0x2AE4:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_WIDE+1556));
				pr_debug("tail1 0x2AE5:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_WIDE+1557));
				pr_debug("tail2 0x2AE6:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_WIDE+1558));
				pr_debug("tail3 0x2AE7:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_WIDE+1559));
				pr_debug("tail4 0x2AE8:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_WIDE+1560));
			} else {
				pr_debug("com 0x24D0:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_TELE));
				pr_debug("com 0x24F7:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_TELE+39));
				pr_debug("innal 0x24F8:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_TELE+40));
				pr_debug("innal 0x2AE4:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_TELE+1556));
				pr_debug("tail1 0x2AE5:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_TELE+1557));
				pr_debug("tail2 0x2AE6:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_TELE+1558));
				pr_debug("tail3 0x2AE7:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_TELE+1559));
				pr_debug("tail4 0x2AE8:0x%x\n", read_cmos_eeprom_8(S5KGW3_STEREO_START_ADDR_TELE+1560));
			}
			pr_debug("s5kgm3write_Module_data Write end\n");
		} else if ((pStereodata->uSensorId == S5KGW3_SENSOR_ID)
			&& (data_base == S5KGW3_AESYNC_START_ADDR)
			...
			pr_debug("readback main aesync: %x %x %x %x %x %x %x %x\n"
				, read_cmos_eeprom_8(S5KGW3_AESYNC_START_ADDR)
				, read_cmos_eeprom_8(S5KGW3_AESYNC_START_ADDR+1)
				, read_cmos_eeprom_8(S5KGW3_AESYNC_START_ADDR+2)
				, read_cmos_eeprom_8(S5KGW3_AESYNC_START_ADDR+3)
				, read_cmos_eeprom_8(S5KGW3_AESYNC_START_ADDR+4)
				, read_cmos_eeprom_8(S5KGW3_AESYNC_START_ADDR+5)
				, read_cmos_eeprom_8(S5KGW3_AESYNC_START_ADDR+6)
				, read_cmos_eeprom_8(S5KGW3_AESYNC_START_ADDR+7));
		} else {
			pr_err("Invalid Sensor id:0x%x write_gm1 eeprom\n", pStereodata->uSensorId);
			return IMGSENSOR_RETURN_ERROR;
		}
	} else {
		pr_err("s5kgw3 write_Module_data pStereodata is null\n");
		return IMGSENSOR_RETURN_ERROR;
	}
	return ret;
}
...
static kal_uint32 s5kgw3_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	LOG_INF("s5kgw3_awb_gain: 0x100\n");
...
static void s5kgw3_set_lsc_reg_setting(
...
static kal_uint16 s5kgw3_capture_setting[] = {
	0x6028, 0x4000,
	0x6214, 0xF9F0,
	0x6218, 0xF150,
	0x6028, 0x2000,
...
static kal_uint16 s5kgw3_preview_setting[] = {
	0x6028, 0x4000,
	0x6214, 0xF9F0,
	0x6218, 0xF150,
	0x6028, 0x2000,
...
static kal_uint16 s5kgw3_normal_video_setting_4K60FPS[] = {
	0x6028, 0x4000,
	0x6214, 0xF9F0,
	0x6218, 0xF150,
	0x6028, 0x2000,
...
static kal_uint16 s5kgw3_normal_video_setting[] = {
	0x6028, 0x4000,
	0x6214, 0xF9F0,
	0x6218, 0xF150,
	0x6028, 0x2000,
...
static kal_uint16 s5kgw3_hs_video_setting[] = {
	0x6028, 0x4000,
	0x6214, 0xF9F0,
	0x6218, 0xF150,
	0x6028, 0x2000,
...
static kal_uint16 s5kgw3_slim_video_setting[] = {
	0x6028, 0x4000,
	0x6214, 0xF9F0,
	0x6218, 0xF150,
	0x6028, 0x2000,
...
static kal_uint16 s5kgw3_custom3_setting[] = {
	0x6028, 0x4000,
	0x6214, 0xF9F0,
	0x6218, 0xF150,
	0x6028, 0x2000,
...
static kal_uint16 s5kgw3_custom4_setting[] = {
	0x6028, 0x4000,
	0x6214, 0xF9F0,
	0x6218, 0xF150,
	0x6028, 0x2000,
...
static kal_uint16 s5kgw3_custom5_setting[] = {
	0x6028, 0x4000,
	0x6214, 0xF9F0,
	0x6218, 0xF150,
	0x6028, 0x2000,
...
static kal_uint16 s5kgw3_custom1_setting[] = {
	0x6028, 0x4000,
	0x6214, 0xF9F0,
	0x6218, 0xF150,
	0x6028, 0x2000,
...
static void preview_setting(void)
{
	...
	s5kgw3_table_write_cmos_sensor(s5kgw3_preview_setting,
		sizeof(s5kgw3_preview_setting)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    if (1) {
	    ...
	    s5kgw3_table_write_cmos_sensor(s5kgw3_capture_setting,
		    sizeof(s5kgw3_capture_setting)/sizeof(kal_uint16));
    }
    //Deng.Cao@Cam.Drv, change the capture setting to preview setting, 20191220 end.
	LOG_INF("%s 30 fpsX\n", __func__);
}
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	if (1) {
		s5kgw3_table_write_cmos_sensor(s5kgw3_slim_video_setting,
			sizeof(s5kgw3_slim_video_setting)/sizeof(kal_uint16));
	} else {
		s5kgw3_table_write_cmos_sensor(s5kgw3_normal_video_setting,
			sizeof(s5kgw3_normal_video_setting)/sizeof(kal_uint16));
	}
	LOG_INF("X\n");
}
...
static void hs_video_setting(void)
{
	...
	s5kgw3_table_write_cmos_sensor(s5kgw3_hs_video_setting,
		sizeof(s5kgw3_hs_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
{
	LOG_INF("%s 7.5 fps E!\n", __func__);
	s5kgw3_table_write_cmos_sensor(s5kgw3_custom3_setting,
		sizeof(s5kgw3_custom3_setting)/sizeof(kal_uint16));
	LOG_INF("%s 7.5 fpsX\n", __func__);
}
...
static void custom4_setting(void)
{
	...
	s5kgw3_table_write_cmos_sensor(s5kgw3_custom4_setting,
		sizeof(s5kgw3_custom4_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void custom5_setting(void)
{
	...
	s5kgw3_table_write_cmos_sensor(s5kgw3_custom5_setting,
		sizeof(s5kgw3_custom5_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void custom1_setting(void)
{
	...
	/*************MIPI output setting************/
	s5kgw3_table_write_cmos_sensor(s5kgw3_custom1_setting,
		sizeof(s5kgw3_custom1_setting)/sizeof(kal_uint16));
	LOG_INF("X");
}
...
static void custom2_setting(void)
{
	...
	/*************MIPI output setting************/
	s5kgw3_table_write_cmos_sensor(s5kgw3_normal_video_setting_4K60FPS,
		sizeof(s5kgw3_normal_video_setting_4K60FPS)/sizeof(kal_uint16));
	LOG_INF("X");
}
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8)
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				read_eepromData();
				LOG_INF("s5kgw3_module_id=%d\n",imgsensor_info.module_id);
				if(deviceInfo_register_value == 0x00){
					register_imgsensor_deviceinfo("Cam_r0", DEVICE_VERSION_S5KGW3,
									imgsensor_info.module_id);
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	{
		LOG_INF("s5kgw3 GET_MODULE_CamInfo:%d %d\n", *feature_para_len, *feature_data_32);
		*(feature_data_32 + 1) = (gS5kgw3_CamInfo[1] << 24)
					| (gS5kgw3_CamInfo[0] << 16)
					| (gS5kgw3_CamInfo[3] << 8)
					| (gS5kgw3_CamInfo[2] & 0xFF);
		*(feature_data_32 + 2) = (gS5kgw3_CamInfo[5] << 24)
					| (gS5kgw3_CamInfo[4] << 16)
					| (gS5kgw3_CamInfo[7] << 8)
					| (gS5kgw3_CamInfo[6] & 0xFF);
	}
		break;
	case SENSOR_FEATURE_GET_MODULE_SN:
	{
		LOG_INF("s5kgw3 GET_MODULE_SN:%d %d\n", *feature_para_len, *feature_data_32);
		if (*feature_data_32 < CAMERA_MODULE_SN_LENGTH/4)
			*(feature_data_32 + 1) = (gS5kgw3_SN[4*(*feature_data_32) + 3] << 24)
						| (gS5kgw3_SN[4*(*feature_data_32) + 2] << 16)
						| (gS5kgw3_SN[4*(*feature_data_32) + 1] << 8)
						| (gS5kgw3_SN[4*(*feature_data_32)] & 0xFF);
	}
		break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
	{
		...
		s5kgw3_set_lsc_reg_setting(index, feature_data_16,
	...
	case SENSOR_FEATURE_GET_EEPROM_DATA:
		...
		memcpy(&feature_para[0], gS5kgw3_EepData, DUALCAM_CALI_DATA_LENGTH_8ALIGN*2);
		break;
	#endif
	default:
		break;
