...
static void SCP_sensorHub_init_sensor_state(void)
{
	...
	sensor_state[SENSOR_TYPE_LUX_AOD].sensorType = SENSOR_TYPE_LUX_AOD;
	sensor_state[SENSOR_TYPE_LUX_AOD].rate = SENSOR_RATE_ONCHANGE;
	sensor_state[SENSOR_TYPE_LUX_AOD].timestamp_filter = true;

	sensor_state[SENSOR_TYPE_FREE_FALL].sensorType = SENSOR_TYPE_FREE_FALL;
	sensor_state[SENSOR_TYPE_FREE_FALL].rate = SENSOR_RATE_ONCHANGE;
	sensor_state[SENSOR_TYPE_FREE_FALL].timestamp_filter = true;

	sensor_state[SENSOR_TYPE_PICKUP_MOTION].sensorType = SENSOR_TYPE_PICKUP_MOTION;
	sensor_state[SENSOR_TYPE_PICKUP_MOTION].rate = SENSOR_RATE_ONCHANGE;
	sensor_state[SENSOR_TYPE_PICKUP_MOTION].timestamp_filter = true;

	sensor_state[SENSOR_TYPE_ACTION_DETECT].sensorType = SENSOR_TYPE_ACTION_DETECT;
	sensor_state[SENSOR_TYPE_ACTION_DETECT].rate = SENSOR_RATE_ONCHANGE;
	sensor_state[SENSOR_TYPE_ACTION_DETECT].timestamp_filter = true;

	sensor_state[SENSOR_TYPE_FFD].sensorType = SENSOR_TYPE_FFD;
	sensor_state[SENSOR_TYPE_FFD].rate = SENSOR_RATE_ONCHANGE;
	sensor_state[SENSOR_TYPE_FFD].timestamp_filter = true;
	//endif 
}
