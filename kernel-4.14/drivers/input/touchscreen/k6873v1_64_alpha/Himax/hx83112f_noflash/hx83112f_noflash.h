 ...
 * VENDOR_EDIT
 * Copyright(C) 2008-2012 custom_o Mobile Comm Corp., Ltd
 * Description:
...
/*Support calculation enter algorithm number*/
#define HX_ENTER_ALGORITHM_NUMBER
...
char *g_hx_inspt_crtra_name[] = {
	"CRITERIA_OPEN_MIN",       "CRITERIA_OPEN_MAX",
	"CRITERIA_MICRO_OPEN_MIN", "CRITERIA_MICRO_OPEN_MAX",
	"CRITERIA_SHORT_MIN",      "CRITERIA_SHORT_MAX",
	"CRITERIA_RAWDATA_MIN", /* CRITERIA_RAW_MIN */
	"CRITERIA_RAWDATA_MAX", /* CRITERIA_RAW_MAX */
	"CRITERIA_NOISE_MAX",      "LPWUG_RAWDATA_MIN",
	"LPWUG_RAWDATA_MAX",       "LPWUG_NOISE_MIN",
	"LPWUG_NOISE_MAX",	 "LPWUG_IDLE_RAWDATA_MIN",
	"LPWUG_IDLE_RAWDATA_MAX",  "LPWUG_IDLE_NOISE_MIN",
	"LPWUG_IDLE_NOISE_MAX",    NULL
};
...
enum THP_AFE_INSPECT_ERR_ENUM {
	...
	THP_AFE_INSPECT_EPIN =
	    (1 << 7),  /* Errors of TSVD!FTSHD!FTRCST!FTRCRQ and other PINs
...
struct chip_data_hx83112f {
	...
	/*hx83112f func provide to hx83112f common driver*/
