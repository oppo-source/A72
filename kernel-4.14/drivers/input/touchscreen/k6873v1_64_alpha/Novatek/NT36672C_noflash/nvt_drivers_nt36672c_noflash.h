...
#define NVT_MMAP_DEBUG_FINGER_DOWN_DIFFDATA                                    \
	(0x26A78) // debug finger diff (finger down)
#define NVT_MMAP_DEBUG_STATUS_CHANGE_DIFFDATA                                  \
	(0x26CB8) // debug finger diff (status change)
