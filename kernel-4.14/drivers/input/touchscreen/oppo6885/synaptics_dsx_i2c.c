...
static int parse_dt(struct device *dev, struct synaptics_dsx_board_data *bdata)
{
	...
	dev_err(dev, 
	"%s:bdata->irq_gpio=%d,bdata->irq_flags=0x%02x,bdata->power_gpio=%d,bdata->reset_gpio=%d\n",
	__func__,bdata->irq_gpio,bdata->irq_flags,bdata->power_gpio,bdata->reset_gpio);
...
{
	int retval;
	pr_err("synaptics_rmi4_i2c_probe\n");
